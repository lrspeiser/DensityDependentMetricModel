...
def plot_master_rotation_curve(gaia_data, params, samples, weights, param_names, save_path='plots/'):
    ...
    plt.savefig(f'{save_path}/rotation_curve_comparison.png', bbox_inches='tight')
    plt.close(fig)
...
def plot_residual_comparison(gaia_data, params, save_path='plots/'):
    ...
    fig.tight_layout()
    plt.savefig(f'{save_path}/residuals_comparison.png', bbox_inches='tight')
    plt.close(fig)
...
def plot_density_enhancement_phase_space(gaia_data, params, save_path='plots/'):
    ...
    fig.tight_layout()
    plt.savefig(f'{save_path}/xi_density_dependence.png', bbox_inches='tight')
    plt.close(fig)
...
def plot_cumulative_mass_profile(params, save_path='plots/'):
    ...
    fig.tight_layout()
    plt.savefig(f'{save_path}/ddmm_enclosed_mass_comparison.png', bbox_inches='tight')
    plt.close(fig)
...
def plot_parameter_corner(samples, weights, param_names, save_path='plots/'):
    ...
    fig.tight_layout()
    plt.savefig(f'{save_path}/corner_plot_masses.png', bbox_inches='tight')
    plt.close(fig)
