...
Rotation comparison (Gaia vs GR vs ER, with extrapolation highlighted): ![Rotation comparison](images/rotation_comparison_tidal_band.png?v=20250809-2)
...
- Posterior weights histogram: ![Tidal Weights](images/tidal_band_weights_hist.png?v=20250809-2)
- Evidence trace (logZ vs iteration): ![Tidal logZ trace](images/tidal_band_logz_trace.png?v=20250809-2)
- 1D posterior marginals (first parameters): ![Tidal 1D marginals](images/tidal_band_marginals_1d.png?v=20250809-2)
- Pairwise projections (top parameters): ![Tidal pairs](images/tidal_band_pairs_top.png?v=20250809-2)

GR baseline diagnostics (runs/gr_20250809_000755):
- Posterior weights histogram: ![GR Weights](images/gr_weights_hist.png?v=20250809-2)
- Evidence trace (logZ vs iteration): ![GR logZ trace](images/gr_logz_trace.png?v=20250809-2)
- 1D posterior marginals (first parameters): ![GR 1D marginals](images/gr_marginals_1d.png?v=20250809-2)
- Pairwise projections (top parameters): ![GR pairs](images/gr_pairs_top.png?v=20250809-2)
